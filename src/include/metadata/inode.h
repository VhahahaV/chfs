...
namespace chfs
{
  ...
  class regular_file_info
  {

  public:
    regular_file_info(block_id_t b, mac_id_t m, version_t v);
    ~regular_file_info();
  ...
  inline regular_file_info::regular_file_info(block_id_t b, mac_id_t m, version_t v) : block_id(b), mac_id(m), version_id(v)
  {
  }

  inline regular_file_info::~regular_file_info()
  {
  }
